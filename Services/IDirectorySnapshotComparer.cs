...
namespace DirectoryChangesTracker.Services
{
	...
	public interface IDirectorySnapshotComparer
	{
		...
		/// </summary>
		/// <param name="directorySnapshotA">The snapshot representing the previous state of the directory.</param>
		/// <param name="directorySnapshotB">The snapshot representing the current state of the directory.</param>
		/// <returns>
		...
		/// </returns>
		Result<ScannedDirectoryResult> Compare(DirectorySnapshot directorySnapshotA, DirectorySnapshot directorySnapshotB);
	}
}
